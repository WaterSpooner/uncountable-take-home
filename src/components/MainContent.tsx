...
import {
  FilterPanelProvider,
  useFilterPanel,
} from '../context/FilterPanelContext';
      ...
      <main className={styles.main}>
        {graphType === 'scatter' && (
          <ScatterPlot
            ...
            xAxisOptions={inputFields}
            yAxisOptions={outputFields}
          />
        )}
        {graphType === 'histogram' && (
          <Histogram dataset={filteredData} xAxisOptions={inputFields} />
        )}
        {graphType === 'table' && (
          <Table dataset={filteredData} selectedFields={selectedFields} />
        )}
      </main>
      <FilterPanel />
    </div>
